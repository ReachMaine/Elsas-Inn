...
mods:  25Nov15 zig - add GTM function after body tag
	   23Nov15 zig - dont show blogname if no image.
*/ ?>
				...
				<div class="large-12 columns header-container">
					...
					<div class="right-links">
						...
						<?php if($flatsome_opt['nav_position'] == 'top_right'){ ?>
							...
							<?php /* zig - moved to under header <li class="html-block">
...
<?php if($flatsome_opt['top_right_text']) { /* zig moved to here */?>
	<div id="top_right_text" class="row">
		<div class="html-block-inner hide-for-small right"><?php echo do_shortcode($flatsome_opt['top_right_text']); ?></div>
	</div>
<?php } ?>
